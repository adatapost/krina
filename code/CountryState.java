...
class CityMap {
	 ...
	 HashMap<String,HashMap<String,HashMap<Integer,String>>> map = new HashMap<>();
	...
	public void addCity(String country, String state, Integer pin, String city) {
		map.get(country).get(state).put(pin,city);
	}
	public Set<String> getCountries() {
		return map.keySet();
	}
	public Set<String> getStates(String country) {
		return map.get(country).keySet();
	}
		public Set<HashMap<Integer,String>> getCities(String country, String state) {
		return map.get(country).get(state).entrySet();
	}
}